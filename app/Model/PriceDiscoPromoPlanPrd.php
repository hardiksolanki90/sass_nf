...
{
	protected $table = "price_disco_promo_plans";

    protected $connection = 'server_mysql';
   // use SoftDeletes, LogsActivity, Organisationid;

    protected $fillable = [
        'uuid', 'organisation_id', 'use_for', 'combination_plan_key_id', 'name', 'start_date', 'end_date', 'combination_key_value',
        //For Promotion
        'order_item_type', 'offer_item_type',
        //For Discount 
        'type', 'qty_from', 'qty_to', 'discount_value', 'discount_percentage', 'discount_apply_on', 'discount_type',
    ...
    public function PDPLob()
    {
        return $this->belongsTo(PDPLob::class, 'price_disco_promo_plan_id', 'id');
    }
    ...
    public function PDPCombinationSlabs()
    {
        return $this->hasMany(PDPCombinationSlab::class, 'price_disco_promo_plan_id', 'id');
    }
}
