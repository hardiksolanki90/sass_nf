...
class StoragelocationPrd extends Model
{
	protected $table = "storagelocations";

    protected $connection = 'server_mysql';
    //use SoftDeletes, LogsActivity, Organisationid;

    protected $fillable = [
        'uuid', 'organisation_id', 'code', 'name', 'route_id', 'warehouse_id', 'warehouse_type', 'warehouse_code', 'loc_type'
    ];
