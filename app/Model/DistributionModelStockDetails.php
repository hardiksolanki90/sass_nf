...
class DistributionModelStockDetails extends Model
{
    ...
    protected $table = 'distribution_model_stock_details';

    protected $fillable = [
        'uuid', 'distribution_model_stock_id', 'distribution_id', 'item_id', 'item_uom_id', 'capacity', 'is_deleted'
    ];
    ...
    {
        return $this->belongsTo(ShelfRack::class,  'rack_id', 'id');
    }
}
