...
class Trip extends Model
{
    ...
    protected $fillable = [
        'uuid', 'organisation_id', 'route_id', 'salesman_id', 'trip_start', 'trip_start_date', 'trip_start_time', 'trip_end', 'trip_end_date', 'trip_end_time', 'trip_status', 'trip_from', 'trip_number'
    ];
