...
class JourneyPlan extends Model
{
    ...
    protected $fillable = [
        'uuid', 'organisation_id', 'route_id', 'is_merchandiser', 'merchandiser_id', 'name', 'description', 'start_date', 'no_end_date', 'end_date', 'start_time', 'end_time', 'plan_type', 'week_1', 'week_2', 'week_3', 'week_4', 'week_5', 'current_stage', 'current_stage_comment', 'status', 'is_enforce'
    ];
