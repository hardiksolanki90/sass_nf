...
class DebitNote extends Model
{
    ...
    protected $fillable = [
        'uuid', 'organisation_id', 'invoice_id', 'customer_id', 'salesman_id', 'route_id', 'debit_note_number', 'debit_note_date', 'payment_term', 'total_qty', 'total_discount_amount', 'total_net', 'total_gross', 'total_vat', 'total_excise', 'grand_total', 'pdc_amount', 'debit_note_comment', 'reason', 'lob_id', 'approval_status'
    ];
