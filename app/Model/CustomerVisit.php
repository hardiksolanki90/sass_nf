...
class CustomerVisit extends Model
{
    ...
    protected $fillable = [
        'uuid', 'organisation_id', 'route_id', 'trip_id', 'customer_id', 'salesman_id', 'journey_plan_id', 'latitude', 'longitude', 'shop_status', 'start_time', 'end_time', 'is_sequnece', 'is_approve', 'date', 'reason', 'comment', 'added_on'
    ];
