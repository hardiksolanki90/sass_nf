...
class CustomerInfoPrd extends Model
{
	    protected $table = "customer_infos";

    protected $connection = 'server_mysql';
  //  use SoftDeletes, LogsActivity, Organisationid, \Staudenmeir\EloquentParamLimitFix\ParamLimitFix;
    ...
    protected $fillable = [
        ...
        'customer_zipcode',
        'customer_phone',
        'customer_address_1_lat',
        'customer_address_1_lang',
        'customer_address_2_lat',
        'customer_address_2_lang',
        'merchandiser_id',
        'balance',
        'credit_limit',
        'credit_days',
    ...
    {
        return $this->hasMany(CustomerMerchandiser::class, 'customer_id', 'user_id');
    }
    ...
    {
        return $this->hasMany(Invoice::class,  'invocie_id', 'user_id');
    }

    public function customerBlockTypes()
    {
        return $this->hasMany(CustomerBlockType::class,  'customer_id', 'id')
            ->where('is_lob', 0);
    }
    ...
    {
        return $this->hasMany(CustomerRoute::class, 'customer_id', 'id')->where('is_lob', 0);
    }
