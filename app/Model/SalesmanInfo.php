...
class SalesmanInfo extends Model
{
    ...
    protected $fillable = [
        'uuid', 'user_id', 'route_id', 'salesman_type_id', 'salesman_role_id', 'salesman_code', 'salesman_supervisor', 'is_block', 'block_start_date', 'block_end_date', 'current_stage', 'current_stage_comment', 'status', 'profile_image'
    ];
