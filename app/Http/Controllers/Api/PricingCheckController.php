    ...
    public function index(Request $request)
    {
        ...
        $pricing_check_query = PricingCheck::select('id', 'brand_id', 'salesman_id', 'customer_id', 'added_on', 'created_at')
            ->with(
                ...
                'pricingDetails.pricingCheckDetailPrices:id,pricing_check_id,pricing_check_detail_id,price,srp,created_at'
            );
            // ->whereHas('pricingDetails.pricingCheckDetailPrices', function ($q) use ($extended_date, $date) {
            //     $q->whereBetween('created_at', [$extended_date, $date]);
            // });
        ...
        if ($request->date) {
		 ...
		 if (count($all_salesman)) {
            $pricing_check_query->whereIn('salesman_id', $all_salesman);
        }
        ...
        $pricing_check = $pricing_check_query->orderBy('id', 'desc')
            ->get();
