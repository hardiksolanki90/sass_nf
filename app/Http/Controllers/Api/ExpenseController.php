...
class ExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        $expense = Expense::select('id', 'uuid', 'customer_id', 'expense_category_id', 'reference', 'description', 'amount', 'expense_date', 'status')
            ->with(
    ...
    public function edit($uuid)
    {
        ...
        $expense = Expense::where('uuid', $uuid)
            ->with('expenseCategory:id,name', 'customer:id,firstname,lastname')
            ->first();
