                ...
                if ($distributions) {
                    $distributionModelStock = DistributionModelStock::select('id', 'customer_id', 'distribution_id')
                        ->with(
                            ...
                            // 'distributionModelStockDetailsWithItem:id,distribution_model_stock_id,distribution_id,item_id,item_uom_id,capacity',
                            // 'distributionModelStockDetailsWithItem.item:id,item_name,item_major_category_id,brand_id',
                            // 'distributionModelStockDetailsWithItem.item.itemMajorCategory:id,name',
                            // 'distributionModelStockDetailsWithItem.item.brand:id,brand_name',
                            // 'distributionModelStockDetailsWithItem.itemUom:id,name'
                        )
