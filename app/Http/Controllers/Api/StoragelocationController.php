...
class StoragelocationController extends Controller
{
    ...
    public function indexAll(Request $request)
    {
        ...
        $storagelocations = Storagelocation::select('id', 'code', 'name');

        if (isset($_REQUEST['id'])) {
            $storagelocations->where('warehouse_type', $_REQUEST['id']);
        }

        $storagelocation = $storagelocations->orderBy('name', 'asc')
            ->get();
    ...
    public function edit($uuid)
    {
        ...
        return prepareResult(true, $Storagelocation, [], "Storagelocation Edit", $this->success);
    }
    ...
    public function JDEWarehouseDownload()
    {
        $response = Curl::to('https://devmobiato.nfpc.net/merchandising/odbc_item_location_date.php')
            ->returnResponseObject()
            ->get();

        return prepareResult(true, [], [], "Download warehouse item.", $this->success);
    }
}
