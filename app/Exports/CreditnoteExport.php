    ...
    public function collection()
    {
        ...
        $creditnotes = DB::table('credit_notes')
            ...
            ->select(
                ...
                'credit_notes.truck_allocated_date',
                'items.item_name',
        ...
        if ($start_date != '' && $end_date != '') {
            if ($start_date == $end_date) {
                $creditnotes->whereBetween('credit_notes.created_at', $start_date);
            } else {
                $creditnotes->whereBetween('credit_notes.created_at', [$start_date, $end_date]);
            }
        }

        $creditnotes = $creditnotes->where('credit_notes.organisation_id', auth()->user()->organisation_id)->get();
