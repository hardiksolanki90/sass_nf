...
class VehicalUtilisationMonthlyReportExport implements FromCollection, WithHeadings
{
    /**
    ...
    {
        $VehicalUtilizationMonthlyCollection = new Collection();
        if (count($this->details)) {
            foreach ($this->details as $value) {
                $VehicalUtilizationMonthlyCollection->push((object) [
            ...
            return $VehicalUtilizationMonthlyCollection;
        }
