...
class User extends Authenticatable
{
    ...
    public function customerMerchandiserByCustomer()
    {
        return $this->hasMany(CustomerMerchandiser::class, 'customer_id', 'id');
    }

    public function customerMerchandiserBysalesman()
    {
        return $this->hasMany(CustomerMerchandiser::class, 'merchandiser_id', 'id');
    }
    ...
    public function userBranchPlantAssing()
    {
        return $this->hasMany(UserBranchPlantAssign::class, 'user_id', 'id');
    }
}
