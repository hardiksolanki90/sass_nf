            ...
            <div class="pcs-template-body">
                ...
                <table style="width: 100%" border="0" class="myfont">
                    <tr>
                        ...
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfo->customer_code}}</td>
                        <td style="width:20%;padding:2px;" >Invoice</td>
                        <td style="width:20%;padding:2px;">: {{$delivery_invoice->delivery_number}}</td>
                    </tr>
                    <tr>
                        <td style="width:18%;padding:2px;" >Sold To </td>
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customer->firstname}}</td>
                        <td style="width:20%;padding:2px;" >Invoice Date </td>
                        <td style="width:20%;padding:2px;">: {{date('d-m-Y', strtotime($delivery_invoice->delivery_date))}}</td>
                    </tr>
                    <tr>
                        <td style="width:18%;padding:2px;" >Address 1 </td>
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfo->customer_address_1}}</td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfo->customer_address_2}}</td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfo->customer_address_3}}</td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfo->trn_detail}}</td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfo->trn_no}} </td>
                ...
                <table style="width:100%;margin-top:20px;" border="0">
                    ...
                    <tbody>
                        @if (count($delivery_invoice->deliveryDetails))
                        @foreach ($delivery_invoice->deliveryDetails as $key=> $item)
                        <tr>
