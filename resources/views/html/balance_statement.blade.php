                ...
                <tr>
                    <td style="padding:20px 0px 0px 5px;">
                        <table cellpadding="0" cellspacing="0" border="0" width="70%">
                            ...
                            <tr>
                                <td>
							<span style="white-space: pre-wrap;" id="tmp_billing_address"><strong><span class="pcs-customer-name" id="zb-pdf-customer-detail"><a href="#/contacts/297877000000007196">{{ $userDetails->firstname." ".$userDetails->lastname }}</a></span></strong>
                        ...
                        <tr class="breakrow-inside breakrow-after ">
                            ...
                            <td class="box-padding">
                                ...
                                @elseif($balance['status']==1)
                                    @php
                                        $balanceAmount = $balanceAmount + $balance['amount'];
                                    @endphp
                                    {{ number_format((float) $balanceAmount, 2, '.', '') }}
                                @elseif($balance['status']==2)
                                    @php
                                        $balanceAmount = $balanceAmount - $balance['payment'];
                                    @endphp
                                    {{ number_format((float) $balanceAmount, 2, '.', '') }}
