        ...
        <div class="pcs-template">
            ...
            <div class="pcs-template-body">
                <div style="text-align: center">
                    ...
                    <hr>
                    <p class="head1">Proforma Invoice</p>
                ...
                <table style="width: 100%" border="0" class="myfont">
                    <tr>
                        ...
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfoDetails->customer_code}}</td>
                        <td style="width:20%;padding:2px;" >Invoice</td>
                        <td style="width:20%;padding:2px;">: {{$delivery_invoice->delivery->delivery_number}}</td>
                    </tr>
                    <tr>
                        <td style="width:18%;padding:2px;" >Sold To </td>
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->user->firstname}}</td>
                        <td style="width:20%;padding:2px;" >Invoice Date </td>
                        <td style="width:20%;padding:2px;">: {{date('d-m-Y', strtotime($delivery_invoice->delivery->delivery_date))}}</td>
                    </tr>
                    <tr>
                        <td style="width:18%;padding:2px;" >Address 1 </td>
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfoDetails->customer_address_1}}</td>
                        <td style="width:20%;padding:2px;" >BU</td>
                        <td style="width:20%;padding:2px;">: {{$delivery_invoice->lob->lob_code}}</td>
                    </tr>
                    <tr>
                        <td style="width:18%;padding:2px;" >Address 2 </td>
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfoDetails->customer_address_2}}</td>
                        <td style="width:20%;padding:2px;" >Branch Plant</td>
                        <td style="width:20%;padding:2px;">: {{$delivery_invoice->storage_location_id}}</td>
                    </tr>
                    <tr>
                        <td style="width:18%;padding:2px;" >Address 3 </td>
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfoDetails->customer_address_3}}</td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfoDetails->trn_detail}}</td>
                        <td style="width:20%;padding:2px;" >LPO No</td>
                        <td style="width:20%;padding:2px;">: {{$delivery_invoice->customer_lpo}}</td>
                    </tr>
                    <tr>
                        <td style="width:18%;padding:2px;" >Cust Trn No </td>
                        <td style="width:50%;padding:2px;">: {{$delivery_invoice->customerInfoDetails->trn_no}} </td>
                ...
                <table style="width:100%;margin-top:20px;" border="0">
                    <thead>
                        <tr style="height:17px;">
                            ...
                            <td style="padding: 4px 7px 2px 7px;width: 33%;" valign="bottom" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                                <b>Description</b>
                            </td>
                    ...
                    <tbody>
                        @foreach ($delivery_invoice->invoices as $key=> $item)
                        <tr>
                        ...
                        <table class="pcs-totals" cellspacing="0" border="0" style="padding: 0px 0px 0px 5px;" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">AED {{ $delivery_invoice->total_gross }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Discount </td>
                                    <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">AED {{ $delivery_invoice->total_discount_amount }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Excise </td>
                                    <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">AED {{ $delivery_invoice->total_excise }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Net Total </td>
                                    <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">AED {{ $delivery_invoice->total_net }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Vat </td>
                                    <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">AED {{ $delivery_invoice->total_vat }}</td>
                                </tr>
                                <tr style="height:40px;" class="pcs-balance">
                                    <td valign="middle" align="right" style="padding: 5px 10px 5px 0;"><b>Total</b></td>
                                    <td id="tmp_total" valign="middle" align="right" style="width:120px;;padding: 10px 10px 10px 5px;"><b>AED {{ $delivery_invoice->grand_total }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
